...
// Txn A connects to Performer A eg: Java Performer
            TransactionBuilder.create(shared, Performer A,  "A")
...
// Txn B connects to Performer B eg: CXX Performer
            TransactionBuilder.create(shared,Performer B, "B")
            .addAttempt(attempt()
